...
export default function AdminDashboard({dashboardData}) {
  ...
  const stats = [
    { title: "Orders", value: dashboardData?.orders ?? 0, icon: <Package />, delay: 0.1, link: "/admin/order/all" },
    { title: "Customers", value: dashboardData?.customers ?? 0, icon: <Users />, delay: 0.2,link: "/admin/order/all" },
    { title: "Products", value: dashboardData?.products ?? 0, icon: <Coffee />, delay: 0.3, link: "/product/all" },
    { title: "Blogs", value: dashboardData?.blogs ?? 0, icon: <BarChart />, delay: 0.4, link:"/admin/blog/all" },
  ];
  return (
