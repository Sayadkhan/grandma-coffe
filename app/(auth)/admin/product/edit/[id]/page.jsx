...
const EditProductPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("variants", JSON.stringify(variants)); // ✅ send variants

      // Only append new images, backend will handle merging
...
const FormInput = ({ label, ...props }) => (
  <div className="mb-3">
    ...
    <input
      {...props}
      className="w-full rounded-lg border p-3 focus:ring-2 focus:ring-amber-500"
    />
  </div>
);
